...
import paymentBadgesRetroImage from './assets/payment/payment-badges-retro-strip.png'
...
function PaymentBadges() {
  return (
    <div className="pay-badges" aria-label="Accepted payments">
      <img className="payment-badge-strip" src={paymentBadgesRetroImage} alt="Visa, Mastercard, and PayPal accepted" />
    </div>
  )
}
